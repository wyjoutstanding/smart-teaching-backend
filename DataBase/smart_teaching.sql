...
CREATE TABLE `class_student`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '班级中学生唯一ID',
...
CREATE TABLE `classes`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '班级唯一ID',
...
CREATE TABLE `file`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '文件唯一ID',
  ...
  `file_type` int(11) NOT NULL COMMENT '文件类型（0：资源，1：作业，2：报告）',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `homework`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '作业唯一ID',
...
CREATE TABLE `question`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '题目（问题）唯一ID',
...
CREATE TABLE `question_bank`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '题库唯一ID',
...
CREATE TABLE `report`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '报告唯一ID',
...
CREATE TABLE `user`  (
  ...
  `account_type` int(11) NOT NULL COMMENT '账户类型（0：学生，1：教师）',
  `account_status` int(11) NULL DEFAULT NULL COMMENT '账户状态（登录、冻结、删除）',
  PRIMARY KEY (`id`) USING BTREE,
